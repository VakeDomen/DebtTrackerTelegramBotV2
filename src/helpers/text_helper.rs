...
pub fn generate_transaction_response(new_transaction: &NewTransaction, success: bool) -> String {
    match success {
        true => format!("Successfully loaned {} to {}!", new_transaction.sum, new_transaction.reciever),
